                    ...
                    <li class="cd-faq__item">
                        ...
                        <div class="cd-faq__content">
                            <div class="text-component">
                                <p class="text-muted">Try using the password reset option in the log-in via this link  <a Forgot Password href="https://upcomingsounds.com/forgot-password "> If that doesn't work,  you might have signed up through Google, Twitter, or Facebook?.. </p>
                            </div>
                        </div>
                    </li>
                    <li class="cd-faq__item">
