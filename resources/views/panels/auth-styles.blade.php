...
<meta property="og:url" content="https://upcomingsounds.com">
    ...
    <title>@yield('title') | {{ config('app.name', 'upcomingsounds.com') }}</title> Welcome to the newest platform for music promotion and pitching service with effective results. Submit your music now! | UpcomingSounds </title>
