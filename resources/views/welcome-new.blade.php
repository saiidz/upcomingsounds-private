...
{{-- page title --}}
@section('title','Discover the Best Platform for New and Upcoming Sounds - offering guaranteed promotion and effective coverage  from industry professionals | Submit Your Music Today!')
@section('page-style')
...
<!-- Schema.org -->
    <script type="application/ld+json">
    {
      ...
      "potentialAction": {
        "@type": "ListenAction",
        "target": "https://upcomingsounds.com/listen"
      }
    }
    </script>
    </body>
