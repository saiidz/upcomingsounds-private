            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content flip-y">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn red p-x-md UscOfferPay" id="payUSCOffer" data-contribution="{{!empty($send_offer->curatorOfferTemplate) ? $send_offer->curatorOfferTemplate->contribution : 0}}" href="javascript:void(0)">Yes</a>
                    </div>
                </div><!-- /.modal-content -->
            </div>
        </div>
