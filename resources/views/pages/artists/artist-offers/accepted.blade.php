                                    ...
                                    <div class="item r Item" data-id="item-{{$sendOffer->id}}">
                                        ...
                                        <div class="item-info">
                                            ...
                                            <div class="m-t-sm offerAlternative">
                                                <div><span style="color:#02b875 !important">Offer Type: </span><span class="btn btn-xs white">{{!empty($sendOffer->curatorOfferTemplate->offerType) ? $sendOffer->curatorOfferTemplate->offerType->name : '----'}}</span></div>
