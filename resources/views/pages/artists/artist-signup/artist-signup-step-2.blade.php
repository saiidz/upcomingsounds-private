                                        ...
                                        <div class="row">
                                            <div class="col s12">
                                                <form method="POST" action="{{route('artist.signup.step.2.post')}}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <a class="tellMeMore left" onclick="window.history.go(-1); return false;" href="javascript:void(0)">Previous
                                                            </a>
                                                            <button class="tellMeMore right" style="border:none;" type="submit">Next
                                                            </button>
                                                        </div>
                                                    </div>
                                                </form>
