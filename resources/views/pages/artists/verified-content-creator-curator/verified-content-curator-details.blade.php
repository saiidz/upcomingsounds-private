...
{{-- page title --}}
@section('title','Verified Content Curator Details')
                        ...
                        <div class="col-sm w w-auto-xs m-b">
                            <div class="item w rounded">
                                <div class="item-media">
                                    @php
                                        $mystring = $verified_content_creator->userCurator->profile;
                                        $findhttps   = 'https';
                                        $findhttp   = 'http';
                                    ...
                                    @endphp
                                    @if($pos === false)
                                        @if(!empty($verified_content_creator->userCurator->profile))
                                            <div class="item-media-content" id="upload_profile"
                                                 style="background-image: url({{URL('/')}}/uploads/profile/{{$verified_content_creator->userCurator->profile}});"></div>
                                        @else
                                            <div class="item-media-content" id="upload_profile"
                                    ...
                                    @elseif($pos == 0)
                                        <div class="item-media-content" id="upload_profile"
                                             style="background-image: url({{$verified_content_creator->userCurator->profile}});"></div>
                                    @else
                                        <div class="item-media-content" id="upload_profile"
                                             style="background-image: url({{asset('images/profile_images_icons.svg')}});"></div>
                                    @endif
                            ...
                            <div>
                                @if (!empty($verified_content_creator->userCurator->curatorUser->curator_bio))
                                    <div class="page-title m-b">
                                        <h4 class="inline m-a-0 biO">Bio</h4>
                                    </div>
                                    <p id="bioInfo" class="text-muted">{{Str::limit($verified_content_creator->userCurator->curatorUser->curator_bio, 50)}}</p>
                        ...
                        <div class="col-sm">
                            <div class="p-l-md no-padding-xs">
                                <div class="page-title">
                                    <h1 class="inline">{{($verified_content_creator->userCurator) ? $verified_content_creator->userCurator->name : ''}}</h1>
                                    @if ($verified_content_creator->userCurator->is_verified == 1)
                                ...
                                <p class="item-desc text-ellipsis text-muted" data-ui-toggle-class="text-ellipsis">
                                    @if(!empty($verified_content_creator->userCurator->curatorUser->curator_signup_from))
                                        {{Str::upper ($verified_content_creator->userCurator->curatorUser->curator_signup_from)}}
                                    @endif
                                </p>
                                @if(!empty($verified_content_creator->userCurator->curatorUser->country))
                                    <div class="block flag_style clearfix m-b">
                                        <img class="flag_icon" src="{{asset('images/flags')}}/{{$verified_content_creator->userCurator->curatorUser->country->flag_icon}}.png" alt="{{$verified_content_creator->userCurator->curatorUser->country->flag_icon}}">
                                        <span class="text-muted"
                                              style="font-size:15px">{{($verified_content_creator->userCurator->curatorUser->country) ? $verified_content_creator->userCurator->curatorUser->country->name : ''}}</span>
                                    </div>
                                @endif
                                <div class="row-col m-b" id="socialView_S">
                                    <div class="col-xs">
                                        @if(!empty($verified_content_creator->userCurator->curatorUser->instagram_url))
                                            <a href="{{$verified_content_creator->userCurator->curatorUser->instagram_url}}" target="_blank"
                                        ...
                                        @endif
                                        @if(!empty($verified_content_creator->userCurator->curatorUser->facebook_url))
                                            <a href="{{$verified_content_creator->userCurator->curatorUser->facebook_url}}" target="_blank"
                                        ...
                                        @endif
                                        @if(!empty($verified_content_creator->userCurator->curatorUser->spotify_url))
                                            <a href="{{$verified_content_creator->userCurator->curatorUser->spotify_url}}" target="_blank"
                                        ...
                                        @endif
                                        @if(!empty($verified_content_creator->userCurator->curatorUser->soundcloud_url))
                                            <a href="{{$verified_content_creator->userCurator->curatorUser->soundcloud_url}}" target="_blank"
                                        ...
                                        @endif
                                        @if(!empty($verified_content_creator->userCurator->curatorUser->youtube_url))
                                            <a href="{{$verified_content_creator->userCurator->curatorUser->youtube_url}}" target="_blank"
                                        ...
                                        @endif
                                        @if(!empty($verified_content_creator->userCurator->curatorUser->website_url))
                                            <a href="{{$verified_content_creator->userCurator->curatorUser->website_url}}" target="_blank"
                                        ...
                                        @endif
                                        @if(!empty($verified_content_creator->userCurator->curatorUser->deezer_url))
                                            <a href="{{$verified_content_creator->userCurator->curatorUser->deezer_url}}" target="_blank"
                                               class="btn btn-icon btn-social rounded btn-social-colored"
                                        ...
                                        @endif
                                        @if(!empty($verified_content_creator->userCurator->curatorUser->apple_url))
                                            <a href="{{$verified_content_creator->userCurator->curatorUser->apple_url}}" target="_blank"
                                               class="btn btn-icon btn-social rounded btn-social-colored"
                                        ...
                                        @endif
                                        @if(!empty($verified_content_creator->userCurator->curatorUser->tiktok_url))
                                            <a href="{{$verified_content_creator->userCurator->curatorUser->tiktok_url}}" target="_blank"
                                               class="btn btn-icon btn-social rounded btn-social-colored"
