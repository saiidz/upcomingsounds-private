...
<div bgcolor="#ffffff" style="background-color: #f7f7f7;">
    ...
    ">
        ...
        font-weight: 500;
        margin: 0;
    ">Hello, my name is {{ $username }},</h2>
                                <p style="color: black;font-size: 18px;font-weight: 400;line-height:24px;margin:0;padding: 20px 0 0;text-align: left;word-break:normal;direction:ltr;">{!! $requestEditTrackAdmin !!}</p>
                        </tr>
                        <tr style="text-align: center;">
                            <td>
                                <a href="{{ route('admin.artist.track.detail', $trackID) }}" class="style="color: black;font-size: 18px;font-weight: 400;line-height:24px;margin:0;padding: 20px 0 0;text-align: left;word-break:normal;direction:ltr;"><i class="material-icons">Track Link</i></a>
                            </td>
                        </tr>
                        </tbody>
                        <tbody>
