                                ...
                                @if(!empty($curators) && count($curators) > 0)
                                    @foreach($curators as $curator)
                                        <div class="col-xs-12 col-sm-4 col-md-3">
                                            <div class="item r" id="coverageVerifiedID{{$curator->id}}" data-link="{{route('artist.coverage.details',encrypt($curator->id))}}" style="cursor:pointer;"  data-id="item-100">
                                                <div class="item-media itemCurator" onclick="coverageVerifiedOpen({{$curator->id}})">
