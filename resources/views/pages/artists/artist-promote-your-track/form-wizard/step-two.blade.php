...
{{--                                                    <ion-icon name="happy"></ion-icon>--}}
            ...
            <div class="item-title bottom text-right form2CheckedBox">
                <input type="checkbox" class="stepTwoReceived" name="received_details" id="received_details" value="1" />
            </div>
        </div>
...
{{--                                                    <ion-icon name="business"></ion-icon>--}}
            ...
            <div class="item-title bottom text-right form2CheckedBox">
                <input type="checkbox" class="stepTwoVisibility"  name="get_visibility" id="get_visibility" value="2" />
            </div>
        </div>
...
{{--                                                    <ion-icon name="business"></ion-icon>--}}
            ...
            <div class="item-title bottom text-right form2CheckedBox">
                <input type="checkbox" class="stepTwoEstablish" name="get_establish" id="get_establish" value="3"/>
            </div>
        </div>
        <div class="sub__title__container">
        ...
        <div class="buttons">
            ...
            <a class="m-b-md rounded addTrack" id="rightNowID" data-id="" onclick="selectSelection()">Select Selection</a>
            {{-- <a class="m-b-md rounded addTrack nxt__btn" onclick="nextForm('step_two');">Next</a> --}}
        </div>
    </div>
</fieldset>
