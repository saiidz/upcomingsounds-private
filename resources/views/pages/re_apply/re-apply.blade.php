                                        ...
                                        <div id="view-input-fields">
                                            <div class="row">
                                                <div class="col s12">
                                                    ...
                                                    <p class="m-b-md" style="text-align:center;">Looks like you have already applied. The application was for: {{ ($user) ? $user->name : '' }} </p>
                                                    <p class="m-b-md" style="text-align:center;">Status - closed / declined</p>
                                                    <p class="m-b-md" style="text-align:center;">More than a month has passed since you applied to join. You can apply</p>

                                                    <div style="text-align:center" class="m-t-2">
                                                        <a href="{{ route('re.apply.submission') }}" class="btn btn-sm rounded primary">Re-APPLY</a>​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
