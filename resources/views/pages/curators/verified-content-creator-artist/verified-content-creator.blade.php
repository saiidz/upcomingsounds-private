                                ...
                                <div class="col-xs-12 remove_offer m-b" id="remove_offer-{{$verifiedContentCreatorCurator->id}}">
                                    <div class="item r Item" data-id="item-{{$verifiedContentCreatorCurator->id}}">
                                        <div class="item-media">
                                            @php
                                                $mystring = $verifiedContentCreatorCurator->artistUser->profile;
                                                $findhttps   = 'https';
                                                $findhttp   = 'http';
                                            ...
                                            @endphp
                                            @if($pos === false)
                                                @if(!empty($verifiedContentCreatorCurator->artistUser->profile))
                                                    <div class="item-media-content" id="upload_profile"
                                                         style="background-image: url({{URL('/')}}/uploads/profile/{{$verifiedContentCreatorCurator->artistUser->profile}});"></div>
                                                @else
                                                    <div class="item-media-content" id="upload_profile"
                                            ...
                                            @elseif($pos == 0)
                                                <div class="item-media-content" id="upload_profile"
                                                     style="background-image: url({{$verifiedContentCreatorCurator->artistUser->profile}});"></div>
                                            @else
                                                <div class="item-media-content" id="upload_profile"
                                                     style="background-image: url({{asset('images/profile_images_icons.svg')}});"></div>
                                            @endif
                                        ...
                                        <div class="item-info">
                                            ...
                                            <div class="item-title text-ellipsis">
                                                <span class="text-muted">{{!empty($verifiedContentCreatorCurator->artistUser) ? $verifiedContentCreatorCurator->artistUser->name : '----'}}</span>
                                            </div>
                                            ...
                                            <div class="m-t-sm campaignBtn" style="display:flex">
                                                <form id="form-artist-verified{{$verifiedContentCreatorCurator->id}}" action="{{route('artist.coverage.verified.show',encrypt($verifiedContentCreatorCurator->id))}}">
