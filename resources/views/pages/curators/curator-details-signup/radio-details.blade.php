                                            ...
                                            <div class="row">
                                                <div class="col s12">
                                                    ...
                                                    <ul class="instagram_details">
                                                        ...
                                                        <li class="text-muted">If you decide not to share their song or write feedback on your Radio / TV, you must provide a rejection reason to get paid. If you do not provide a rejection reason, the artists will get a refund.</li>
                                                        <li class="text-muted">Unless you are a verified  Radio / TV, you will receive the standard fee of 1 USC coin = 1 GBP per submission.  (payouts range from 1 to 60 USC , Depending on engagement and followers.)</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="row">
