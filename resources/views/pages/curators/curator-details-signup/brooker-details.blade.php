...
{{-- page title --}}
@section('title','Brooker / Booking Agent  Signup ')
                                            ...
                                            <div class="row">
                                                <div class="col s12">
                                                    ...
                                                    <ul class="instagram_details">
                                                        <li class="text-muted">Brooker Musicians / Artists will send you music.</li>
                                            ...
                                            <div class="row">
                                                <div class="col s12">
                                                    ...
                                                    <ul class="instagram_details">
                                                        ...
                                                        <li class="text-muted">Unless you are a verified  professional, Artist manager,  Brooker, you will receive the standard fee of 1 USC coin = 1 GBP per submission</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="row">
