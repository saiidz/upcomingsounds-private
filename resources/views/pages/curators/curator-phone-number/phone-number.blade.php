...
{{-- page title --}}
@section('title','Phone Number Taste Maker Signup ')
                                ...
                                <div id="input-fields" class="card card-tabs cardsTep2">
                                    <div class="card-content">
                                        <div id="view-input-fields">
                                            <div class="row">
                                                <div class="col s12">
                                                    <form method="POST" action="{{route('curator.phone.number.post')}}" id="mobile-login-form" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col s12">
                                                                <div class="input-field col s12">
                                                                    ...
                                                                    <small class="red-text display-none" role="alert" id="errror-client-side" style="display:block">
                                                                    </small>
                                                                </div>
                                                                @error('phone_number')
