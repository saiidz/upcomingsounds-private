...
<body style="margin: 0px;background-color: #f8fbff;">
    <div bgcolor="#ffffff" style="background-color: #f7f7f7;">
        <center>
            <table border="0" cellspacing="0" cellpadding="0" align="center" width="650" bgcolor="#ffffff" style="min-width:650px;font-family: Roboto,Arial;background-color: #f7f7f7;">
                <tbody>
                <tr style="
    ">
                    <td height="50"></td>
        ...
        display: block;
        padding: 0 0 30px 0;
    "><a href="{{config('app.url')}}" rel="noreferrer" target="_blank" style="
        text-align: center;
    ...
    ">
                            ...
                            <tr style="text-align: center;">
                                <td align="center" style="margin: 0;display: inline-block;padding: 50px 34px;"><h2 style="
        font-size: 25px;
        text-align: left;
        line-height: 41px;
        color: #383760;
        ...
        margin: 0;
    ">Hello {{ $username }},</h2>
                                    <p style="color: black;font-size: 18px;font-weight: 400;line-height:24px;margin:0;padding: 20px 0 0;text-align: left;word-break:normal;direction:ltr;">{!! $approvedMessage !!}</p>
                                    {{-- <p style="color: black;font-size: 18px;font-weight: 400;line-height:24px;margin:0;padding: 20px 0 0;text-align: left;word-break:normal;direction:ltr;">Now, you are approved, you can use all artist features of UpcomingSounds. Please Click Here <a href="https://upcomingsounds.com" target="_blank" style="color: #383760;font-size: 18px;text-decoration: none; font-weight: 500;">UpcomingSounds</a></p> --}}
                    ...
                    <td><table border="0" cellspacing="0" cellpadding="0" align="center" width="100%">
                            ...
                            <tr>
                                <td align="center" dir="ltr"><p style="color: #383760;font-size: 18px;line-height:17px;margin:0;padding: 15px 80px 15px 80px;text-align:center;word-break:normal;direction:ltr;">Headquarters 29-31 Parliament Street, Liverpool, England, L8 5RN</p>
                                    <p style="color: #383760;font-size: 18px;line-height:17px;margin:0;padding: 0 80px 0 80px;text-align:center;word-break:normal;direction:ltr;">Info@upcomingsounds.com</p></td>
                            </tr>
                            <tr>
        ...
        text-decoration: none; font-weight: 500;">https://upcomingsounds.com</a></td>
                            </tr>
                            <tr>
