...
<body style="margin: 0px;background-color: #f8fbff;">
    ...
    ">
        ...
        margin: 0;
    ">Hello {{ $username }},</h2>
                                    <p style="color: black;font-size: 18px;font-weight: 400;line-height:24px;margin:0;padding: 20px 0 0;text-align: left;word-break:normal;direction:ltr;">{!! $rejectTrackMessage !!}</p>
                            </tr>
                            </tbody>
                            <tbody>
                            </tbody>
