...
<!-- END: Head-->
<body
    class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu preload-transitions 1-column   blank-page blank-page"
...
{{--                                <p class="margin medium-small"><a href="{{ route('admin.login')}}">Login</a></p>--}}
                            ...
                            <div class="input-field col s6 m6 l6">
                                <p class="margin right-align medium-small"><a href="{{ route('admin.login')}}">Login</a></p>
