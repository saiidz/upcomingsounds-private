...
<div id="approvedModal" class="modal">
    <form class="new_basicform_approved_with_reload" action="{{ route('admin.store.approved.OfferTemplate', $offer_template->id) }}" id="approvedCuratorForm" method="post">
        @csrf
...
<div id="rejectModal" class="modal">
    <form class="new_basicform_reject_with_reload" action="{{ route('admin.store.OfferTemplate.reject', $offer_template->id) }}" id="rejectCuratorForm" method="post">
        @csrf
        <div class="modal-content">
            <div class="modal-header">
