...
<div id="approvedModal" class="modal">
    <form class="new_basicform_approved_with_reload" action="{{ route('admin.store.verified.coverage.approved.submitWork', $submitWork->id) }}" id="approvedCuratorForm" method="post">
        @csrf
...
<div id="rejectSubmitModal" class="modal">
    <form class="new_basicform_reject_with_reload" action="{{ route('admin.store.verified.coverage.submitWork.reject', $submitWork->id) }}" id="rejectCuratorForm" method="post">
        @csrf
        <div class="modal-content">
            <div class="modal-header">
...
<div id="refundArtistModal" class="modal">
    <form class="new_basicform_refund_artist_with_reload" action="{{ route('admin.verified.coverage.artist.refund.waller', $submitWork->id) }}" id="rejectCuratorForm" method="post">
        @csrf
        <div class="modal-content">
            <div class="modal-header">
