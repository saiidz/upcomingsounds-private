                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Blocked Bidder List</span></h5>
                        </div>
                    </div>
                </div>
            </div>
                                                    ...
                                                    @isset($bidders)
                                                        @foreach($bidders as $bidder)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if($bidder->status == 'block')
                                                                        <span class="chip red lighten-5 red-text">Blocked</span>
                                                                    @endif
                                                                </td>
                                                                <td>
        ...
        function viewBidder(bidder_id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#bidder_status').html('<span class="chip red lighten-5 red-text">Blocked</span>');
                }
            });
        }
    </script>
