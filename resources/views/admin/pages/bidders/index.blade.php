                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Bidder List</span></h5>
                        </div>
                    </div>
                </div>
            </div>
         ...
         function viewBidder(bidder_id) {
             ...
             $.ajax({
                 ...
                 success: function (data) {
                     ...
                     $('#bidder_status').html('<span class="chip green lighten-5 green-text">Active</span>');
                 }
             });
         }
    </script>
