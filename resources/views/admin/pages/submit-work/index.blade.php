                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Submit Works</span></h5>
                            <ol class="breadcrumbs mb-0">
                                @include('admin.panels.breadcrumbs')
                                <li class="breadcrumb-item active">Submit Works </li>
                            </ol>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    @if (!empty($submitWorks))
                                                        @foreach ($submitWorks as $submitWork)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('admin.curator.submit.work.detail', $submitWork->id) }}"><i class="material-icons">remove_red_eye</i></a>
{{--                                                                    <a class="dropdown-item has-icon delete-confirm" href="javascript:void(0)" data-id={{ $offerTemplate->id }}>--}}
{{--                                                                        <img class="editDell" src="{{asset('images/delete_forever.svg')}}">--}}
{{--                                                                    </a>--}}
{{--                                                                    <!-- Delete Form -->--}}
{{--                                                                    <form class="d-none" id="delete_form_{{ $offerTemplate->id }}" action="{{ route('admin.curator.delete.offer.template', $offerTemplate->id) }}" method="POST">--}}
{{--                                                                        @csrf--}}
{{--                                                                        @method('DELETE')--}}
{{--                                                                    </form>--}}
                                                                </td>
