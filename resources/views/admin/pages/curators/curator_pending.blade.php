			...
			<div class="container">
				<div class="row">
					<div class="col s10 m6 l6">
						<h5 class="breadcrumbs-title mt-0 mb-0"><span>Curator Pending</span></h5>
						<ol class="breadcrumbs mb-0">
                            @include('admin.panels.breadcrumbs')
							<li class="breadcrumb-item active">Curator Pending </li>
						</ol>
					</div>
				</div>
									...
									<div class="row">
										<div class="col s12">
											<table id="page-length-option" class="table">
                                                ...
                                                <tbody>
                                                    @if (!empty($pending_curators))
                                                        @foreach ($pending_curators as $pending_curator)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('admin.curator.profile', $pending_curator->id) }}" target="_blank"><i class="material-icons">remove_red_eye</i></a>
                                                                    <a class="dropdown-item has-icon delete-confirm" href="javascript:void(0)" data-id={{ $pending_curator->id }}>
                                                                        <img class="editDell" src="{{asset('images/delete_forever.svg')}}">
                                                                    </a>
                                                                    <!-- Delete Form -->
                                                                    <form class="d-none" id="delete_form_{{ $pending_curator->id }}" action="{{ route('admin.curator.destroy', $pending_curator->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                    </form>
                                                                </td>
