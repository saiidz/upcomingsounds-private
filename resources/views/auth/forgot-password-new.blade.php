...
<head>
    ...
    <title> Forget Password | {{ config('app.name', 'Welcome to the newest platform for music promotion and pitching service with effective results. Submit your music now! | UpcomingSounds') }}</title>
                        ...
                        <div class="auth-form">
                            ...
                            <div class="auth-form__body">
                                <form name="reset" method="POST" action="{{ route('password.email') }}">
                                    ...
                                    <a href="{{ route('register') }}" class="auth-form__forgot-link">
                                        Sign in
                                    </a><!---->
                                </form>
                            </div>
