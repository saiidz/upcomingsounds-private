                    ...
                    <div class="row-col UScarousel" style="background-image: url({{asset('images/Banner_UCSWEB1.jpg')}});">
                        ...
                        <div class="col-lg-8 text-center">
                            <div class="">
                                ...
                                <h6 class="m-b-lg SliderP">More impressions drive more success. Reach more fans, listeners and professionals in the most effective way. </h6>
                    ...
                    <div class="row-col UScarousel" style="background-image: url({{asset('images/Banner_UCSWEB2.jpg')}});">
                        ...
                        <div class="col-lg-8 text-center">
                            <div class="">
                                ...
                                <h6 class="m-b-lg SliderP">Media coverage can increase the public's awareness of your music. </h6>
                    ...
                    <div class="row-col UScarousel" style="background-image: url({{asset('images/Banner_UCSWEB3.jpg')}});">
                        ...
                        <div class="col-lg-8 text-center">
                            <div class="">
                                ...
                                <h6 class="m-b-lg SliderP">It takes more than a great product to stand out in the crowded music industry. Insightful planning and smart execution are necessary to take your music where you want it to go.</h6>
