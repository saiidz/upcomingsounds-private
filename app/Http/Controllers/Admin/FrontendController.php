...
//            'award_image'                  => 'mimes:png,jpg',
        ...
        $data = [
            'description_three_end_section' => $request->description_three_end_section ?? null,
            'title_three_end_section'       => $request->title_three_end_section ?? null,
            'description_two_end_section'   => $request->description_two_end_section ?? null,
            ...
            'image'                         => !empty($image_new_path) ? $image_new_path : (!empty($image_new) ? $image_new : null),
            ...
            'curator_description_two'       => $request->curator_description_two ?? null,
            'curator_description'           => $request->curator_description ?? null,
            'curator_title'                 => $request->curator_title ?? null,
