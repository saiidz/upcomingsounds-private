(function ($) {
    ...
    $(document).on('click.site', '.btn-more', function(e) {
      ...
      if( $dp.html() == "" ){
        $dp.append('<a class="dropdown-item" href="#"><i class="fa fa-plus fa-fw text-left"></i> Add to Queque</a><a class="dropdown-item" href="#"><i class="fa fa-music fa-fw text-left"></i> Add to Playlist</a>');
